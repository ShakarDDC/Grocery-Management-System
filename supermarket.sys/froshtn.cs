    ...
    public partial class froshtn : Form
    {
        ...
        private void lekdan_colomun()
        {
            ...
            try
            {
                ...
                {
                double a = Convert.ToDouble(row.Cells[dataGridView_bashi_froshtn.Columns[4].Index].Value);
                double b = Convert.ToDouble(row.Cells[dataGridView_bashi_froshtn.Columns[5].Index].Value);
                row.Cells[dataGridView_bashi_froshtn.Columns[6].Index].Value = (a * b);
                ...
                {
                    y += Convert.ToInt32(dataGridView_bashi_froshtn.Rows[x].Cells[6].Value);
                }
                lbl_dinar.Text=y.ToString();
                int rowidx=dataGridView_bashi_froshtn.Rows.Count - 1;
                dataGridView_bashi_froshtn.Rows[rowidx].Cells[6].Value = y;
                ...
                foreach (DataGridViewRow row in dataGridView_bashi_froshtn.Rows)
                {
                    double a1 = Convert.ToDouble(row.Cells[dataGridView_bashi_froshtn.Columns[5].Index].Value);
                    double b1 = Convert.ToDouble(row.Cells[dataGridView_bashi_froshtn.Columns[7].Index].Value);
                    row.Cells[dataGridView_bashi_froshtn.Columns[8].Index].Value = (a1 * b1);
                ...
                {
                    y1 += Convert.ToInt32(dataGridView_bashi_froshtn.Rows[x1].Cells[8].Value);
                }
                lbl_dinar.Text = y.ToString();
                int rowidx1 = dataGridView_bashi_froshtn.Rows.Count - 1;
                dataGridView_bashi_froshtn.Rows[rowidx1].Cells[8].Value = y1;
        ...
        {
            if (dataGridView_bashi_froshtn.CurrentCell != null)
            {


                if (dataGridView_bashi_froshtn.Columns[e.ColumnIndex].Name == "Remove" && dataGridView_bashi_froshtn.CurrentRow.Index != dataGridView_bashi_froshtn.Rows.Count)
                {

                   var barcode= dataGridView_bashi_froshtn.CurrentRow.Cells[2].Value.ToString();

                    SqlDataAdapter sa = new SqlDataAdapter($"delete from FROSHTN where barcode={barcode}", con);
                    SqlDataAdapter saa = new SqlDataAdapter($"delete from print_froshtn where barcode={barcode}", con);
                    dataGridView_bashi_froshtn.Rows.RemoveAt(dataGridView_bashi_froshtn.CurrentRow.Index);
                    lekdan_colomun();
        ...
        private void btn_rakeshan_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dataGridView_bashi_froshtn.RowCount-1; i++)
            {
                string Id = dataGridView_bashi_froshtn.Rows[i].Cells[1].Value.ToString();
                string ItemName= dataGridView_bashi_froshtn.Rows[i].Cells[3].Value.ToString();
                string SalePrice= dataGridView_bashi_froshtn.Rows[i].Cells[4].Value.ToString();
                string Quantity= dataGridView_bashi_froshtn.Rows[i].Cells[5].Value.ToString();
                string TotalPrice= dataGridView_bashi_froshtn.Rows[i].Cells[6].Value.ToString();
                dataTable.Rows.Add(Id,ItemName,SalePrice,Quantity,TotalPrice);
            }


            print_froshraw a =new print_froshraw(dataTable);
            a.Show();
        }
